...
* [#norm:Zicfilp_forward_trap_async_exception]#Synchronous exceptions with priority higher than that of a software-check
  ...
  xref:machine.adoc#norm:exc_priority[Synchronous exception priority in 
decreasing priority order] of Privileged Specification).#
...
See also xref:rnmi.adoc#rnmi["Smrnmi" Extension for Resumable Non-Maskable Interrupts] for semantics added to the RNMI trap and the MNRET instruction
