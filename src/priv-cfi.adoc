...
delivery to S/HS-mode, an `SPELP` bit is provided in the `mstatus` CSR.# [#norm:elp_sstatus_spelp]#The TODO
...
the Shadow Stack (SS) page – in the single-stage and VS-stage page tables. [#norm:ss_page_enc]#The TODO
