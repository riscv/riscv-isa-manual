...
[%autowidth,width=45%,cols="^,<,^,<",options="header"]
|===
|Hart 0 | |Hart 1 |
| |&#8942; | |&#8942;
| |li t1,1 | |li t4,4
...
[[litmus-sample]]
.Sample litmus test
graphviz::images/graphviz/litmus_sample.txt[width=180]
--
...
[%autowidth,cols="<,<",align="center",options="header",]
|===
...
[IMPORTANT]
====
Load Value Axiom: Each byte of each load _i_ returns the value written
