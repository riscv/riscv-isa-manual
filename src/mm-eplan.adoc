...
[IMPORTANT]
====
<<mm-progress, Progress Axiom>>: No memory operation may be preceded in the global
...
[IMPORTANT]
====
_Rule 9: b has a syntactic address dependency on a
Rule 10: b has a syntactic data dependency on a
Rule 11: b is a store, and b has a syntactic control dependency on a_
====
