...
[IMPORTANT]
====
Rule <<overlapping-ordering, 5>>: a has an acquire annotation

Rule <<overlapping-ordering, 6>>: b has a release annotation

Rule <<overlapping-ordering, 7>>: a and b both have RCsc annotations

Rule <<overlapping-ordering, 8>>: a is paired with b
====
