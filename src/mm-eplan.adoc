...
<<litmus_lrsdsc>>: In all four (independent) instances, the store-conditional (c) is permitted but not guaranteed to succeed.
...
Now, consider the alternative in <<spinlock_fences>>. In
