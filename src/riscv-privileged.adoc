...
:footnote:
:imagesdir: images
// Path root for the bytefield/wavedrom partials included by machine.adoc.
// Antora overrides this in antora.yml with the equivalent resource ID.
:priv-partials: images/
