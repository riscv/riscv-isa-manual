...
This section formalizes the RVWMO memory model in an operational style.

\subsection{Introduction to the RVWMO Operational Model}
...
The following subsections describe the formal operational model.
