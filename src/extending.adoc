...
xref:rv-32-64g.adoc#sec:opcodemap[RISC-V base opcode map], each of which represents a 25-bit
...
gray in xref:rv-32-64g.adoc#sec:opcodemap[RISC-V base opcode map]).
