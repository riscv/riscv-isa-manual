...
conversion instructions. [#norm:fcvt_int_quad]#FCVT.W.Q or FCVT.L.Q converts a quad-precision
floating-point number to a signed 32-bit or 64-bit integer,
respectively#. [#norm:fcvt_quad_int]#FCVT.Q.W or FCVT.Q.L converts a 32-bit or 64-bit signed
integer, respectively, into a quad-precision floating-point number#.
[#norm:fcvt_quad_unsigned]#FCVT.WU.Q, FCVT.LU.Q, FCVT.Q.WU, and FCVT.Q.LU variants convert to or
from unsigned integer values#. [#norm:fcvt_quad_long_rv64_only]#FCVT.L[U].Q and FCVT.Q.L[U] are RV64-only
...
floating-point-to-floating-point conversion instructions. [#norm:fcvt_single_quad]#FCVT.S.Q or
...
[#norm:fcvt_double_quad]#FCVT.D.Q or FCVT.Q.D converts a quad-precision floating-point number to
