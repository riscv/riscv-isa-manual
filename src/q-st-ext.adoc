...
described in xref:d-st-ext.adoc#nanboxing[NaN Boxing of Narrower Values] is now extended
...
include::unpriv:partial$wavedrom/quad-ls.adoc[]
[[quad-ls]]
...
include::unpriv:partial$wavedrom/quad-compute.adoc[]
[[quad-compute]]
...
include::unpriv:partial$wavedrom/quad-cnvrt-mv.adoc[]
[[quad-cnvrt-mv]]
...
include::unpriv:partial$wavedrom/quad-cnvt-interchange.adoc[]
...
include::unpriv:partial$wavedrom/quad-cnvrt-intch-xqqx.adoc[]
...
include::unpriv:partial$wavedrom/quad-float-compare.adoc[]
[[quad-float-compare]]
...
include::unpriv:partial$wavedrom/quad-float-clssfy.adoc[]
[[quad-float-clssfy]]
