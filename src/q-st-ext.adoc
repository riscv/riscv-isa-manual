...
include::{incimages}wavedrom/quad-ls.edn[]
[[quad-ls]]
...
include::{incimages}wavedrom/quad-compute.edn[]
[[quad-compute]]
...
include::{incimages}wavedrom/quad-cnvrt-mv.edn[]
[[quad-cnvrt-mv]]
...
include::{incimages}wavedrom/quad-cnvt-interchange.edn[]
...
include::{incimages}wavedrom/quad-cnvrt-intch-xqqx.edn[]
...
include::{incimages}wavedrom/quad-float-compare.edn[]
[[quad-float-compare]]
...
include::{incimages}wavedrom/quad-float-clssfy.edn[]
[[quad-float-clssfy]]
