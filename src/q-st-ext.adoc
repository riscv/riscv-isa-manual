...
include::{incimage}wavedrom/quad-ls.edn[]
[[quad-ls]]
...
include::{incimage}wavedrom/quad-compute.edn[]
[[quad-compute]]
...
include::{incimage}wavedrom/quad-cnvrt-mv.edn[]
[[quad-cnvrt-mv]]
...
include::{incimage}wavedrom/quad-cnvt-interchange.edn[]
...
include::{incimage}wavedrom/quad-cnvrt-intch-xqqx.edn[]
...
include::{incimage}wavedrom/quad-float-compare.edn[]
[[quad-float-compare]]
...
include::{incimage}wavedrom/quad-float-clssfy.edn[]
[[quad-float-clssfy]]
