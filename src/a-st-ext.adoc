...
The A standard extension comprises instructions provided by the Zaamo and Zalrsc
extensions.
...
[[sec:lrsc]]
=== "Zalrsc" Standard Extension for Load-Reserved/Store-Conditional Instructions
...
The standard Zalrsc extension defines _constrained LR/SC loops_, which have
...
[[sec:amo]]
=== "Zaamo" Standard Extension for Atomic Memory Operations
