...
contains a code identifying the last trap cause.  Table~\ref{scauses}
lists the possible trap codes for the current supervisor ISAs, in
descending order of priority.  The Trap Code is a \wlrl\ field,
so is only guaranteed to hold supported trap codes.
