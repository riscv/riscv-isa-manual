...
0 & 1 & The PTE follows the rules specified in the Zsn extension \\
...
translations, as defined in the Zsn extension in Chapter~\ref{napotpages}.
...
In Sv39 and Sv48, when a PTE has N=1 and C=0, the PTE represents a
