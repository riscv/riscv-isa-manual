...
Note:: As for Zvkg, the DIEL mandate is independent from the support of `Zvkt`: Zvkg(s) defines instructions used primarily for cryptography and there are of little use if their execution latency can leak information about input data.
