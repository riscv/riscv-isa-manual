...
\begin{table}[hbt]
  ...
  \begin{tabular}{|c|l|c|}
    ...
    \em Zsn Extension  & \em 0.1  & \em Draft \\
...
\item Added the Zsn Standard Extension draft, along with the N bit in Sv39
  and Sv48 PTEs
...
\item Clarify that PTEs with reserved bits set should trigger access-fault
  exceptions
\end{itemize}
