...
<<opcodemap, Table 38>> shows a map of the major opcodes for
...
instruction set described in <<compressed, Chapter 18>> can
...
these more specialized additions. <<extending, Chapter 28>>
...
<<rvgcsrnames, Table 39>> lists the CSRs that have currently been
