...
[%autowidth,float="center",align="center",cols=  ">.^4m,  ^.^4m,    ^.^4m,      ^.^4m,    ^.^4m,  ^.^4m,      ^.^4m,           ^.^6m, ^.^4m"]
|===
...
[%autowidth,float="center",align="center",cols="1,1,1,4", frame=all, grid=cols,options="header"]
|===
