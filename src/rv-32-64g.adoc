...
<<opcodemap, Table 1>> shows a map of the major opcodes for
...
these more specialized additions. xref:extending.adoc[Extending the RISC-V ISA]
...
<<rvgcsrnames, Table 2>> lists the CSRs that have currently been
