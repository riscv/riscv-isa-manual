...
[#norm:imm_always_sex]#Except for the 5-bit immediates used in CSR instructions (xref:zicsr.adoc#csrinsts[CSR Instructions]),
...
described in xref:zicsr.adoc#csrinsts[CSR Instructions], and the base
