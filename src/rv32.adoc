...
include::images/wavedrom/immediate_variants2.adoc[]
...
|LUI |_rd_=`x0` |latexmath:[$2^{20}$] .8+<.^m|_Reserved for future standard use_
...
|ADD |rd_=`x0`, _rs1_=`x0`, _rs2_=`x2-x5` |4|(_rs2_=`x2`) NTL.P1 + 
(_rs2_=`x3`) NTL.PALL +
(_rs3_=`x4`) NTL.S1 +
(_rs2_=`x5`)

|SUB |_rd_=`x0` |latexmath:[$2^{10}$] .11+<.^m|_Reserved for future standard use_
