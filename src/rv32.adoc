...
image::instruction-formats.edn[]

image:wavedrom/instruction-formats.edn[]

image::risc-v_logo.png[]
...
image::wavedrom/immediate-variants.edn[]
...
image::wavedrom/i-immediate.edn[]

image::wavedrom/s-immediate.edn[]

image::wavedrom/b-immediate.edn[]

image::wavedrom/u-immediate.edn[]

.Types of immediate produced by RISC-V instructions.
image::wavedrom/j-immediate.edn[]
...
image::wavedrom/integer-computational.edn[]
//.Integer Computational Instructions
...
image::wavedrom/int-comp-slli-srli-srai.edn[]
...
image::wavedrom/int-comp-lui-aiupc.edn[]
[[int-comp-lui-aiupc]]
...
image::wavedrom/int-reg-reg.edn[]
[[int-reg-reg]]
...
image::wavedrom/ct-unconditional.edn[]
[[ct-unconditional]]
...
image::wavedrom/ct-unconditional-2.edn[]
[[ct-unconditional-2]]
...
image::wavedrom/ct-conditional.edn[]
[[ct-conditional]]
//.Conditional branches
...
image::wavedrom/env-call-breakpoint.edn[]
