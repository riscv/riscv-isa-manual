...
include::{incimage}wavedrom/instruction-formats.edn[]
...
include::{incimage}wavedrom/immediate-variants.edn[]
...
include::{incimage}wavedrom/i-immediate.edn[]

include::{incimage}wavedrom/s-immediate.edn[]

include::{incimage}wavedrom/b-immediate.edn[]

include::{incimage}wavedrom/u-immediate.edn[]

.Types of immediate produced by RISC-V instructions.
include::{incimage}wavedrom/j-immediate.edn[]
...
include::{incimage}wavedrom/integer-computational.edn[]
//.Integer Computational Instructions
...
include::{incimage}wavedrom/int-comp-slli-srli-srai.edn[]
...
include::{incimage}wavedrom/int-comp-lui-aiupc.edn[]
[[int-comp-lui-aiupc]]
...
include::{incimage}wavedrom/int-reg-reg.edn[]
[[int-reg-reg]]
...
include::{incimage}wavedrom/nop.edn[]
[[nop]]
//.NOP instructions
...
include::{incimage}wavedrom/ct-unconditional.edn[]
[[ct-unconditional]]
...
include::{incimage}wavedrom/ct-unconditional-2.edn[]
[[ct-unconditional-2]]
...
include::{incimage}wavedrom/ct-conditional.edn[]
[[ct-conditional]]
//.Conditional branches
...
include::{incimage}wavedrom/load-store.edn[]
...
include::{incimage}wavedrom/mem-order.edn[]
[[mem-order]]
//.Memory ordering instructions
...
include::{incimage}wavedrom/env-call-breakpoint.edn[]
[[env-call]]
...
in xref:c-st-extension.adoc["C" Extension for Compressed Instructions].
