...
include::{incimages}wavedrom/instruction-formats.edn[]
...
include::{incimages}wavedrom/immediate-variants.edn[]
...
include::{incimages}wavedrom/i-immediate.edn[]

include::{incimages}wavedrom/s-immediate.edn[]

include::{incimages}wavedrom/b-immediate.edn[]

include::{incimages}wavedrom/u-immediate.edn[]

.Types of immediate produced by RISC-V instructions.
include::{incimages}wavedrom/j-immediate.edn[]
...
include::{incimages}wavedrom/integer-computational.edn[]
//.Integer Computational Instructions
...
include::{incimages}wavedrom/int-comp-slli-srli-srai.edn[]
...
include::{incimages}wavedrom/int-comp-lui-aiupc.edn[]
[[int-comp-lui-aiupc]]
...
include::{incimages}wavedrom/int-reg-reg.edn[]
[[int-reg-reg]]
...
include::{incimages}wavedrom/nop.edn[]
[[nop]]
//.NOP instructions
...
include::{incimages}wavedrom/ct-unconditional.edn[]
[[ct-unconditional]]
...
include::{incimages}wavedrom/ct-unconditional-2.edn[]
[[ct-unconditional-2]]
...
include::{incimages}wavedrom/ct-conditional.edn[]
[[ct-conditional]]
//.Conditional branches
...
include::{incimages}wavedrom/load-store.edn[]
...
include::{incimages}wavedrom/mem-order.edn[]
[[mem-order]]
//.Memory ordering instructions
...
include::{incimages}wavedrom/env-call-breakpoint.edn[]
[[env-call]]
