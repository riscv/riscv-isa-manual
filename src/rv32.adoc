...
[[manual__instruction_andi_ori_xori]]
...
[NOTE]
====
[[manual__no_misaligned_instruction_exception_without_c]]
...
|Yes |Yes |No |[#manual__ras_hint_pop_push]#Pop, then push#
