...
i.e., `XLEN=32`.
[#norm:x0_is_zero]#Register `x0` is hardwired with all bits equal to 0.#
...
[[norm:instruction_andi_ori_xori]]
...
[NOTE]
====
[[norm:no_misaligned_instruction_exception_without_c]]
...
|Yes |Yes |No |[#norm:ras_hint_pop_push]#Pop, then push#
