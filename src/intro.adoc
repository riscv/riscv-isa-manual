...
base ISA. xref:extending.adoc[Extending RISC-V] describes various ways
...
described in xref:c-st-extension.adoc["C" Extension for Compressed Instructions] reduces code size by
