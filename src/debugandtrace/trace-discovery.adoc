...
This chapter defines a number of parameters for describing aspects of
...
other instruction trace parameters mentioned in the trace chapters, and <<tab:dataAttributes>> lists attributes related to
data trace.
