...
[[Zvdot4a8i,Zvdot4a8i]]
=== `Zvdot4a8i` - Vector quad widening 4D Dot Product of 8-bit Integers, Version 0.1
...
[[insns-vdota4, Vector SEW/4-bit Signed-Signed 4-Element Dot Product]]
==== vdota4.[vv,vx]
...
[[insns-vdota4u, Vector `SEW/4`-bit Unsigned 4-Element Dot Product]]
==== vdota4u.[vv,vx]
...
[[insns-vdota4su, Vector `SEW/4`-bit Signed-Unsigned 4-Element Dot Product]]
==== vdota4su.[vv,vx]
...
[[insns-vdota4us, Vector `SEW/4`-bit Unsigned-Signed 4-Element Dot Product]]
==== vdota4us.vx
