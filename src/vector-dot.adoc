...
// include::vector-dot-product-zvdot4a8i.adoc[]
// <<<
...
// include::insns/vdota4.adoc[leveloffset=+2]
// <<<
...
image::png/isa-vdota4-vv.png[width=500]


.Encoding (Vector-Scalar)
image::png/isa-vdota4-vx.png[width=500]
...
Description::
`vdota4` performs a partial dot product of two vectors of 8-bit signed integers,
...
// include::insns/vdota4u.adoc[leveloffset=+2]
// <<<

[[insns-vdota4u, Vector 8-bit Unsigned Dot Product]]
==== vdota4u.[vv,vx]
...
.Encoding (Vector-Vector)
image::png/isa-vdota4u-vv.png[width=500]

.Encoding (Vector-Scalar)
image::png/isa-vdota4u-vx.png[width=500]
...
Description::
`vdota4u` performs a partial dot product of two vectors of 8-bit unsigned integers,
...
// include::insns/vdota4su.adoc[leveloffset=+2]
// <<<

[[insns-vdota4su, Vector 8-bit Signed-Unsigned Dot Product]]
==== vdota4su.[vv,vx]
...
.Encoding (Vector-Vector)
image::png/isa-vdota4su-vv.png[width=500]

.Encoding (Vector-Scalar)
image::png/isa-vdota4su-vx.png[width=500]
...
Description::
`vdota4su` performs a partial dot product of a vector of 8-bit signed integers by a vector of 8-bit unsigned integers,
accumulating the partial sums into a vector of 32-bit signed integers.
+
In the vector-vector (`.vv`) variant,
...
// include::insns/vdota4us.adoc[leveloffset=+2]
// <<<

[[insns-vdota4us, Vector 8-bit Unsigned-Signed Dot Product]]
==== vdota4us.vx
...
.Encoding (Vector-Scalar)
image::png/isa-vdota4us-vx.png[width=500]
...
Description::
`vdota4us` performs a partial dot product of a vector of 8-bit unsigned integers by a vector of 8-bit signed integers,
accumulating the partial sums into a vector of 32-bit signed integers.
+
