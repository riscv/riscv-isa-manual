...
[[Zvdot4a8i,Zvdot4a8i]]
=== `Zvdot4a8i` - Vector 4-element Dot Product of packed 8-bit Integers, Version 0.1
...
[[insns-vdot4a, Vector SEW/4-bit Signed-Signed 4-Element Dot Product]]
==== vdot4a.[vv,vx]

Synopsis::
Vector SEW/4-bit Signed-Signed 4-Element Dot Product
...
[[insns-vdot4au, Vector `SEW/4`-bit Unsigned 4-Element Dot Product]]
==== vdot4au.[vv,vx]

Synopsis::
Vector `SEW/4`-bit Unsigned 4-Element Dot Product
...
[[insns-vdot4asu, Vector `SEW/4`-bit Signed-Unsigned 4-Element Dot Product]]
==== vdot4asu.[vv,vx]

Synopsis::
Vector `SEW/4`-bit Signed-Unsigned 4-Element Dot Product
...
[[insns-vdot4aus, Vector `SEW/4`-bit Unsigned-Signed 4-Element Dot Product]]
==== vdot4aus.vx

Synopsis::
Vector `SEW/4`-bit Unsigned-Signed 4-Element Dot Product
