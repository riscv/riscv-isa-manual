...
[#norm:Zimop_mop-r_op]#The Zimop extension defines 32 MOP instructions named MOP.R.__n__, where
...
[#norm:Zcmop_instr_write]#Unlike the MOPs defined in the Zimop extension, the C.MOP.__n__ instructions
