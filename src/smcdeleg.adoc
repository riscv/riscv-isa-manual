...
If extension Smstateen is implemented, refer to extension Smcsrind/Sscsrind (xref:indirect-csr.adoc["Smcsrind/Sscsrind" Indirect CSR Access]) for how setting bit 60 of CSR
