...
builds upon the RV32I variant described in xref:rv32.adoc[].
...
include::{incimage}wavedrom/rv64i-base-int.edn[]
[[rv64i-base-int]]
...
include::{incimage}wavedrom/rv64i-slli.edn[]
[[rv64i-slli]]
...
include::{incimage}wavedrom/rv64i-slliw.edn[]
[[rv64i-slliw]]
...
include::{incimage}wavedrom/rv64-lui-auipc.edn[]
[[rv64_lui-auipc]]
...
include::{incimage}wavedrom/rv64i-int-reg-reg.edn[]
[[int_reg-reg]]
...
xref:rv32.adoc[]) are also HINTs in RV64I.
