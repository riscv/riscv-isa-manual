...
|ADDI |_rd_=`x0`, and either _rs1_≠`x0` or _imm_≠0  |2^17^−1
...
|ADD |_rd_=`x0`, _rs1_≠`x0` |2^10^−32

|ADD |_rd_=`x0`, _rs1_=`x0`, _rs2_≠_x2_-_x5_ | 28
...
|FENCE |_rd_=`x0`, _rs1_≠`x0`,_fm_=0, and either _pred_=0 or _succ_=0 |2^10^−63
