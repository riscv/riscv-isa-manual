...
64 bits (XLEN=64 in the xref:rv32.adoc#gprs[RISC-V base unprivileged integer register state] table).
...
include::partial$wavedrom/rv64i-base-int.edn[]
...
include::partial$wavedrom/rv64i-slli.edn[]
[[rv64i-slli]]
...
include::partial$wavedrom/rv64i-slliw.edn[]
[[rv64i-slliw]]
...
include::partial$wavedrom/rv64-lui-auipc.edn[]
[[rv64_lui-auipc]]
...
include::partial$wavedrom/rv64i-int-reg-reg.edn[]
[[int_reg-reg]]
