...
results to 64 bits.# [#norm:insts:slliw_srliw_sraiw:imm_5_rsv]#SLLIW, SRLIW, and SRAIW encodings with
...
[#norm:inst:lui:rv64_operation]#LUI places the
...
[#norm:inst:auipc:rv64_operation]#AUIPC forms a 32-bit offset from the U-immediate, filling in the lowest
...
[#norm:inst:ld:operation]#The LD instruction loads a 64-bit value from memory into register _rd_
for RV64I.#
(((RV64I, LD)))
...
[#norm:inst:lwu:rv64i_operation]#The LWU instruction, on the other hand, zero-extends the 32-bit value from
