...
|LUI |_rd_=`x0` |2^20^ .9+.^|_Designated for future standard use_
...
|ADD |_rd_=`x0`, _rs1_=`x0`, _rs2_{ne}_x2_-_x5_ | 28

|ADD |_rd_=`x0`, _rs1_=`x0`, _rs2_=_x2_-_x5_| 4 | (_rs2_=_x2_) NTL.P1 +
 (_rs2_=_x3_) NTL.PALL +
 (_rs2_=_x4_) NTL.S1 +
 (_rs2_=_x5_) NTL.ALL
...
|SUB |_rd_=`x0` |2^10^ .16+.^| _Designated for future standard use_
...
|SLTI |_rd_=`x0` |2^17^ .10+.^|_Designated for custom use_
