...
builds upon the RV32I variant described in xref:rv32.adoc[RV32I Base Integer Instruction Set, Version 2.1].
...
64 bits (XLEN=64 in xref:rv32.adoc#gprs[RISC-V base unprivileged integer register state]).
...
include::unpriv:partial$wavedrom/rv64i-base-int.edn[]
[[rv64i-base-int]]
...
include::unpriv:partial$wavedrom/rv64i-slli.edn[]
[[rv64i-slli]]
...
include::unpriv:partial$wavedrom/rv64i-slliw.edn[]
[[rv64i-slliw]]
...
include::unpriv:partial$wavedrom/rv64-lui-auipc.edn[]
[[rv64_lui-auipc]]
...
include::unpriv:partial$wavedrom/rv64i-int-reg-reg.edn[]
[[int_reg-reg]]
...
xref:rv32.adoc[RV32I Base Integer Instruction Set, Version 2.1]) are also HINTs in RV64I.
...
described in xref:rv32.adoc#ecall-ebreak[Environment Call and Breakpoints].
