...
.Floating-point control and status register
include::unpriv:partial$wavedrom/float-csr.adoc[]
...
include::unpriv:partial$wavedrom/sp-load-store-2.adoc[]
[[sp-ldst]]
//.SP load and store
...
include::unpriv:partial$wavedrom/spfloat.adoc[]
[[spfloat]]
//.Single-Precision Floating-Point Computational Instructions
...
FMADD.S multiplies the values in _rs1_ and _rs2_, adds the value in _rs3_, and writes the final result to _rd_. FMADD.S computes _(rs1latexmath:[\times]rs2)latexmath:[+]rs3_.

FMSUB.S multiplies the values in _rs1_ and _rs2_, subtracts the value in _rs3_, and writes the final result to _rd_. FMSUB.S computes _(rs1latexmath:[\times]rs2)latexmath:[-]rs3_.
...
include::unpriv:partial$wavedrom/spfloat2.adoc[]
[[fnmaddsub]]
...
include::unpriv:partial$wavedrom/spfloat-cn-cmp.adoc[]
[[fcvt]]
...
include::unpriv:partial$wavedrom/spfloat-sign-inj.adoc[]
[[inj]]
...
include::unpriv:partial$wavedrom/spfloat-mv.adoc[]
[[spfloat-mv]]
...
include::unpriv:partial$wavedrom/spfloat-comp.adoc[]
[[spfloat-comp]]
...
include::unpriv:partial$wavedrom/spfloat-classify.adoc[]
[[spfloat-classify]]
