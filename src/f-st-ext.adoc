...
(latexmath:[\mbox{\emph rs1} = \mbox{\em rs2}], latexmath:[\mbox{\em rs1} < \mbox{\em rs2}], latexmath:[\mbox{\em rs1} \leq \mbox{\em rs2}]) writing 1 to the integer register _rd_ if the
