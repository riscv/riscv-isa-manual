...
.Floating-point control and status register
include::{incimages}wavedrom/float-csr.edn[]
...
include::{incimages}wavedrom/sp-load-store-2.edn[]
[[sp-ldst]]
//.SP load and store
...
include::{incimages}wavedrom/spfloat.edn[]
[[spfloat]]
//.Single-Precision Floating-Point Computational Instructions
...
include::{incimages}wavedrom/spfloat2.edn[]
[[fnmaddsub]]
...
include::{incimages}wavedrom/spfloat-cn-cmp.edn[]
[[fcvt]]
...
include::{incimages}wavedrom/spfloat-sign-inj.edn[]
[[inj]]
...
include::{incimages}wavedrom/spfloat-mv.edn[]
[[spfloat-mv]]
...
include::{incimages}wavedrom/spfloat-comp.edn[]
[[spfloat-comp]]
...
include::{incimages}wavedrom/spfloat-classify.edn[]
[[spfloat-classify]]
