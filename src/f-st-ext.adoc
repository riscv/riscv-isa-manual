...
.Floating-point control and status register
include::{incimage}wavedrom/float-csr.edn[]
...
include::{incimage}wavedrom/sp-load-store-2.edn[]
[[sp-ldst]]
//.SP load and store
...
include::{incimage}wavedrom/spfloat.edn[]
[[spfloat]]
//.Single-Precision Floating-Point Computational Instructions
...
include::{incimage}wavedrom/spfloat2.edn[]
[[fnmaddsub]]
...
include::{incimage}wavedrom/spfloat-cn-cmp.edn[]
[[fcvt]]
...
include::{incimage}wavedrom/spfloat-sign-inj.edn[]
[[inj]]
...
include::{incimage}wavedrom/spfloat-mv.edn[]
[[spfloat-mv]]
...
include::{incimage}wavedrom/spfloat-comp.edn[]
[[spfloat-comp]]
...
include::{incimage}wavedrom/spfloat-classify.edn[]
[[spfloat-classify]]
