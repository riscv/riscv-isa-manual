...
with the IEEE 754-2008 arithmetic standard cite:[ieee754-2008].# [#norm:f_depends_zicsr]#The F extension depends on the "Zicsr" extension for control and status register access.#
