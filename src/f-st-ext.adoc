...
[#norm:F_fpr_regs]#The F extension adds 32 floating-point registers, `f0-f31`, each 32
...
[[norm:roundingmode_rne_rtz_rdn_rup_rmm]]
[[rm]]
...
[#norm:fflags_op]#The accrued exception flags indicate the exception conditions that have
...
single-precision floating-point subtraction of _rs2_ from _rs1_#. [#norm:fdiv-s_op]#FDIV.S performs the single-precision floating-point division of _rs1_ by _rs2_#. [#norm:fsqrt-s_op]#FSQRT.S computes the square root of _rs1_#. In each case, the result is written to _rd_.
