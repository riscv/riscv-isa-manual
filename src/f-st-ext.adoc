...
.Floating-point control and status register
include::partial$wavedrom/float-csr.adoc[]
...
include::partial$wavedrom/sp-load-store-2.adoc[]
[[sp-ldst]]
//.SP load and store
...
include::partial$wavedrom/spfloat.adoc[]
[[spfloat]]
//.Single-Precision Floating-Point Computational Instructions
...
include::partial$wavedrom/spfloat2.adoc[]
[[fnmaddsub]]
...
include::partial$wavedrom/spfloat-cn-cmp.adoc[]
[[fcvt]]
...
include::partial$wavedrom/spfloat-sign-inj.adoc[]
[[inj]]
...
include::partial$wavedrom/spfloat-mv.adoc[]
[[spfloat-mv]]
...
include::partial$wavedrom/spfloat-comp.adoc[]
[[spfloat-comp]]
...
include::partial$wavedrom/spfloat-classify.adoc[]
[[spfloat-classify]]
