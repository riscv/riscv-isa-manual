...
Tables \ref{tab:CSRRWPriv-notM} and~\ref{tab:CSRRWPriv-M}.
The top two bits (csr[11:10]) indicate whether
...
\tt   11   &\tt   00  &\tt   00XX   & \tt 0xC00-0xC3F & Standard read-only \\
\tt   11   &\tt   00  &\tt   010X   & \tt 0xC40-0xC5F & Standard read-only \\
\tt   11   &\tt   00  &\tt   011X   & \tt 0xC60-0xC7F & Standard read-only, with side effects \\
...
\tt   11   &\tt   01  &\tt   00XX   & \tt 0xD00-0xD3F & Standard read-only \\
\tt   11   &\tt   01  &\tt   010X   & \tt 0xD40-0xD5F & Standard read-only \\
\tt   11   &\tt   01  &\tt   011X   & \tt 0xD60-0xD7F & Standard read-only, with side effects \\
...
\tt   11   &\tt   10  &\tt   00XX   & \tt 0xE00-0xE3F & Standard read-only \\
\tt   11   &\tt   10  &\tt   010X   & \tt 0xE40-0xE5F & Standard read-only \\
\tt   11   &\tt   10  &\tt   011X   & \tt 0xE60-0xE7F & Standard read-only, with side effects \\
...
for privilege levels other than machine level.%
}
\label{tab:CSRRWPriv-notM}
\end{table*}
...
\tt   11   &\tt   11  &\tt   00XX   & \tt 0xF00-0xF3F & Standard read-only \\
\tt   11   &\tt   11  &\tt   010X   & \tt 0xF40-0xF5F & Standard read-only \\
\tt   11   &\tt   11  &\tt   011X   & \tt 0xF60-0xF7F & Standard read-only, with side effects \\
\tt   11   &\tt   11  &\tt   10XX   & \tt 0xF80-0xFBF & Standard read-only \\
\tt   11   &\tt   11  &\tt   11XX   & \tt 0xFC0-0xFFF & Custom read-only \\
\hline
\end{tabular}
\end{center}
\caption{Allocation of RISC-V CSR address ranges for machine privilege level.}
\label{tab:CSRRWPriv-M}
\end{table*}
...
Tables \ref{tab:CSRRWPriv-notM} and~\ref{tab:CSRRWPriv-M}
also indicate the convention to allocate CSR
...
Reads of standard read-only CSRs do not have side effects unless
the CSR address is in a range that explicitly allows them:
{\tt 0xC60}--{\tt 0xC7F} for user-level CSRs,
{\tt 0xD60}--{\tt 0xD7F} for supervisor-level CSRs,
{\tt 0xE60}--{\tt 0xE7F} for hypervisor CSRs, and
{\tt 0xF60}--{\tt 0xF7F} for machine-level CSRs.
