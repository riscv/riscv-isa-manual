...
operations.# [#norm:remw_remuw_result_sign]#Both REMW and REMUW always sign-extend the 32-bit result
...
<<mult-ops,Multiplication Operations>>, namely: MUL, MULH, MULHU,
