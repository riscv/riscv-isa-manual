...
The term insn:push[] refers to insnlink:cm.push[].

The term insn:pop[] refers to insnlink:cm.pop[].

The term insn:popret[] refers to insnlink:cm.popret[] and insnlink:cm.popretz[].
...
** insnlink:cm.popretz[] also moves zero into _a0_ as the return value
...
range available in the encoding; if the range is insufficient then a separate insnlink:c.addi16sp[] can be used to increase the range.
...
Examples of insnlink:cm.popret[] and insnlink:cm.popretz[] are not included, as the difference in the expanded sequence from insnlink:cm.pop[] is trivial in all cases.

===== insnlink:cm.push[\{ra, s0-s2},-64]
...
===== insnlink:cm.push[\{ra, s0-s11},-112]
...
insnlink:cm.push[\{reg_list},-stack_adj]
...
insnlink:cm.pop[\{reg_list},stack_adj]
...
insnlink:cm.popretz[\{reg_list},stack_adj]
...
insnlink:cm.popret[\{reg_list},stack_adj]
