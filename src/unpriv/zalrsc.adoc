...
[#norm:constrained_lrsc_forward_progress_intro]#If a hart _H_ enters a constrained LR/SC loop, the execution environment
must guarantee that one of the following events eventually occurs#:

* [#norm:constrained_lrsc_forward_progress_sc]#_H_ or some other hart executes a successful SC to the reservation set
...
* [#norm:constrained_lrsc_forward_progress_branch]#_H_ executes a branch or jump that exits the constrained LR/SC loop.#
