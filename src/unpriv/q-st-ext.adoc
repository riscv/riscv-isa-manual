...
floating-point, which adds [#norm:q_ieee_compliance]#computational instructions
compliant with the IEEE 754-2008 arithmetic standard's binary128 format and
operations.# The ext:q[] extension depends on the <<chap:d,D>> extension.
