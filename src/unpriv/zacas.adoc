...
in `rs2` and `rd` are vacated.# [#norm:Zacas_rv32_amocas-d_rs2_frst_reg_x0]#When the first register of a source register
...
`rs2` and `rd` are vacated.# [#norm:Zacas_rv64_amocas-q_rs2_frst_reg_x0]#When the first register of a source register pair
