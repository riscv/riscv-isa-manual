...
Each element of the result is formed by using the corresponding index element
from _rs2_ to select an element from _rs1_, or zero if the index element is out
of bounds.
