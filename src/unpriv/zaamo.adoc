...
efficiently. Although the insnlink:fence[r,rw] instruction suffices to implement
the _acquire_ operation and insnlink:fence[rw,w] suffices to implement _release_,
