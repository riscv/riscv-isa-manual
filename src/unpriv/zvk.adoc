...
* [#norm:vsha2chl_vv_vdoverlapvs1vs2_rsv]#The _vd_ register group overlaps with either _vs1_ or _vs2_#
...
[#norm:vsha2chl_vv_op]#Two words of _vs1_ are processed with
