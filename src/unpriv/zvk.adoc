...
in the ext:zvbb[] extension: insnlink:vbrev.v[], insnlink:vclz.v[], insnlink:vctz.v[],
insnlink:vcpop.v[], insnlink:vwsll.vv[], insnlink:vwsll.vx[], and insnlink:vwsll.vi[].
====
...
|Mnemonic
|Instruction
| 32 | 128 | insnlink:vghsh.vv[] | <<insns-vghsh>>
| 32 | 128 | insnlink:vgmul.vv[] | <<insns-vgmul>>
...
| 32| 128 | insnlink:vaeskf1.vi[] | <<insns-vaeskf1>>
| 32| 128 | insnlink:vaeskf2.vi[] | <<insns-vaeskf2>>
| 32| 128 | insnlink:vaesz.vs[]   | <<insns-vaesz>>
|===
...
// | 128
| insnlink:vsha2ms.vv[]   | <<insns-vsha2ms>>
// | 128
...
| 32 | 128 | insnlink:vsm4k.vi[]  | <<insns-vsm4k>>
...
| 32 | 256 | insnlink:vsm3me.vv[] | <<insns-vsm3me>>
| 32 | 256 | insnlink:vsm3c.vi[]  | <<insns-vsm3c>>
|===
...
- insnlink:vwmaccu.vv[]
- insnlink:vwmaccu.vx[]
- insnlink:vwmaccsu.vv[]
- insnlink:vwmaccsu.vx[]
- insnlink:vwmaccus.vx[]
...
- insnlink:vrgather.vv[]
- insnlink:vrgather.vx[]
- insnlink:vrgather.vi[]
- insnlink:vrgatherei16.vv[]
...
====== slide
- insnlink:vslide1up.vx[]
- insnlink:vslide1down.vx[]
- insnlink:vfslide1up.vf[]
- insnlink:vfslide1down.vf[]

In the insnlink:vslideup.vx[] and insnlink:vslidedown.vx[] instructions, the value in _rs1_
is used for control (i.e., slide amount) and therefore is exempt
from DIEL.

- insnlink:vslideup.vx[]
- insnlink:vslideup.vi[]
- insnlink:vslidedown.vx[]
- insnlink:vslidedown.vi[]
...
- reduce
* insnlink:vredsum.vs[]
* insnlink:vwredsum.vs[]
* insnlink:vwredsumu.vs[]
* insnlink:vredand.vs[]
* insnlink:vredor.vs[]
* insnlink:vredxor.vs[]
* insnlink:vredmax.vs[]
* insnlink:vredmaxu.vs[]
* insnlink:vredmin.vs[]
* insnlink:vredminu.vs[]
- shift round
* insnlink:vssra.vv[]
* insnlink:vssra.vx[]
* insnlink:vssra.vi[]
...
===== insnlink:vaesdf.vv[] and insnlink:vaesdf.vs[]

Synopsis::
Vector AES final-round decryption

Mnemonic::
insnlink:vaesdf.vv[vd,vs2] +
insnlink:vaesdf.vs[vd,vs2]
...
===== insnlink:vaesdm.vv[] and insnlink:vaesdm.vs[]

Synopsis::
Vector AES middle-round decryption

Mnemonic::
insnlink:vaesdm.vv[vd,vs2] +
insnlink:vaesdm.vs[vd,vs2]
...
===== insnlink:vaesef.vv[] and insnlink:vaesef.vs[]

Synopsis::
Vector AES final-round encryption

Mnemonic::
insnlink:vaesef.vv[vd,vs2] +
insnlink:vaesef.vs[vd,vs2]
...
===== insnlink:vaesem.vv[] and insnlink:vaesem.vs[]

Synopsis::
Vector AES middle-round encryption

Mnemonic::
insnlink:vaesem.vv[vd,vs2] +
insnlink:vaesem.vs[vd,vs2]
...
Mnemonic::
insnlink:vaeskf1.vi[vd,vs2,uimm]
...
Mnemonic::
insnlink:vaeskf2.vi[vd,vs2,uimm]
...
This instruction only exists in the insn:*.vs[] form because the insn:*.vv[] form would be identical to the insnlink:vxor.vv[vd,vs2,vd] instruction.
====
...
[NOTE]
====
This instruction is identical to insnlink:vghsh.vv[] with _vs1_=0.
...
doesn't use the add-multiply form of the insnlink:vghsh.vv[] instruction.
====
...
===== insnlink:vsha2ch.vv[] and insnlink:vsha2cl.vv[]

Synopsis::
Vector SHA-2 two rounds of compression.

Mnemonic::
insnlink:vsha2ch.vv[vd,vs2,vs1] +
insnlink:vsha2cl.vv[vd,vs2,vs1]
...
Mnemonic::
insnlink:vsha2ms.vv[vd,vs2,vs1]
...
===== insnlink:vsm4r.vv[] and insnlink:vsm4r.vs[]

Synopsis::
Vector SM4 Rounds

Mnemonic::
insnlink:vsm4r.vv[vd,vs2] +
insnlink:vsm4r.vs[vd,vs2]
