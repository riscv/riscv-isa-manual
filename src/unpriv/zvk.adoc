...
[[ext:zvbb]]
===== ext:zvbb[] Vector Basic Bit-manipulation

Vector basic bit-manipulation instructions.

[NOTE]
====
This extension is a superset of the extlink:zvkb[] extension.
====
...
[[ext:zvbc]]
===== ext:zvbc[] Vector Carry-less Multiplication
...
Included in::
extlink:zvbb[], extlink:zvkb[], extlink:zvkn[], extlink:zvknc[], extlink:zvkng[], extlink:zvks[]
extlink:zvksc[], extlink:zvksg[]
...
Included in::
extlink:zvbc[], extlink:zvknc[], extlink:zvksc[]
