...
Mnemonic::
insnlink:vfwmaccbf16.vv[vd,vs1,vs2,vm]
insnlink:vfwmaccbf16.vf[vd,rs1,vs2,vm]
...
This insnlink:vfwmaccbf16.vv[] instruction is equivalent to widening each of the BF16 inputs to
...
Likewise, insnlink:vfwmaccbf16.vf[] is equivalent to the following instruction sequence:
