...
[#norm:Zimop_mop_r_op]#The ext:zimop[] extension defines 32 MOP instructions named MOP.R.__n__, where
...
[[norm:Zimop_mop_r_enc]]
include::images/wavedrom/mop-r.edn[]
[[mop-r]]

[#norm:Zimop_mop_rr_op]#The ext:zimop[] extension additionally defines 8 MOP instructions named
