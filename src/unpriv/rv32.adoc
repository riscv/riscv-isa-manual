...
coprocessors or I/O devices. [#norm:fence_cons_ok]#Simple implementations may additionally
...
[#norm:ecall_service_request_op]#The insn:ecall[] instruction is used to make a service request to the execution environment.#
...
[#norm:ebreak_debug_env_op]#The insn:ebreak[] instruction is used to return control to a debugging environment.#
