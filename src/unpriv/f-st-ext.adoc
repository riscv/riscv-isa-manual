...
This chapter describes the F standard extension for _single-precision_
...
binary32 format and operations.# [#norm:f_depends_zicsr]#The F extension depends
on the "Zicsr" extension for control and status register access.#
