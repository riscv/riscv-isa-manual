...
This chapter describes the ext:f[] standard extension for _single-precision_
floating-point, which adds [#norm:f_ieee_compliance]#computational instructions
compliant with the <<ieee754-2008, IEEE 754-2008 arithmetic standard>>'s
binary32 format and operations.# [#norm:f_depends_zicsr]#The ext:f[] extension
depends on the extlink:zicsr[] extension for control and status register access.#
...
instructions were amended to implement the IEEE 754-2019 cite:[ieee754-2019]
