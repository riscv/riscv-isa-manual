...
[#norm:NTL_target_definition]#The NTL instructions do not change architectural state, nor do they alter the
...
But, since using other loads and stores within an LR/SC loop _does_ void the
