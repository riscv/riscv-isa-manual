...
(insnlink:vfncvt.x.f.w[], insnlink:vfncvt.xu.f.w[], insnlink:vfncvt.rtz.x.f.w[], and insnlink:vfncvt.rtz.xu.f.w[]) and integer-to-floating-point
widening conversions (insnlink:vfwcvt.f.x.v[] and insnlink:vfwcvt.f.xu.v[]) become defined when SEW=8.#
