...
[#norm:fld_op]#The insnlink:fld[] instruction loads a double-precision floating-point value from
memory into floating-point register _rd_#. [#norm:fsd_op]#insnlink:fsd[] stores a double-precision
...
insnlink:fld[] and insnlink:fsd[] are only guaranteed to execute atomically if the effective
address is naturally aligned and XLEN{ge}64.

[[norm:fld_fsd_bits_maintained]]
insnlink:fld[] and insnlink:fsd[] do not modify the bits being transferred; in particular, the
...
instructions are encoded in the OP-FP major opcode space. [#norm:fcvt-w-d_fcvt-l-d_op]#insnlink:fcvt.w.d[] or
...
respectively, in integer register _rd_#. [#norm:fcvt-d-w_fcvt-d-l_op]#insnlink:fcvt.d.w[] or insnlink:fcvt.d.l[] converts a
...
_rd_#. [#norm:fcvt-wu-d_fcvt-lu-d_fcvt-d-wu_fcvt-d-lu_op]#insnlink:fcvt.wu.d[], insnlink:fcvt.lu.d[], insnlink:fcvt.d.wu[], and insnlink:fcvt.d.lu[] variants convert to
or from unsigned integer values#. [#norm:fcvt-w-d_fcvt-wu-d_sign_ext]#For RV64, insnlink:fcvt.w.d[] and insnlink:fcvt.wu.d[] sign-extend the
32-bit result#. [#norm:fcvt_long_double_rv64_only]#insnlink:fcvt.l.d[], fcvt.lu.d[], fcvt.d.l[], and fcvt.d.lu[] are RV64-only instructions.#
[#norm:fcvt_int_double_valid_input]#The range of valid inputs for insnlink:fcvt.w.d[], insnlink:fcvt.wu.d[], insnlink:fcvt.l.d[], and insnlink:fcvt.lu.d[] and the behavior of these instructions for invalid
inputs are the same as for insnlink:fcvt.w.s[], insnlink:fcvt.wu.s[], insnlink:fcvt.l.s[], and insnlink:fcvt.lu.s[]#.
All floating-point to integer and integer to floating-point conversion
instructions round according to the _rm_ field. Note that insnlink:fcvt.d.w[] and insnlink:fcvt.d.wu[] always
...
double-precision conversion instructions, insnlink:fcvt.s.d[] and insnlink:fcvt.d.s[], are
...
destination#. [#norm:fcvt_float_rounding]#insnlink:fcvt.s.d[] rounds according to the _rm_ field; insnlink:fcvt.d.s[] will
never round#.
...
Floating-point to floating-point sign-injection instructions, insnlink:fsgnj.d[],
insnlink:fsgnjn.d[], and insnlink:fsgnjx.d[], are defined analogously to the single-precision
...
[#norm:fmv-x-d_op]#insnlink:fmv.x.d[] moves the double-precision value in
floating-point register _rs1_ to a representation in the IEEE 754-2008
encoding in integer register _rd_#. [#norm:fmv-d-x_op]#insnlink:fmv.d.x[] moves the
...
insnlink:fmv.x.d[] and insnlink:fmv.d.x[] do not modify the bits being transferred; in
...
The double-precision floating-point classify instruction, insnlink:fclass.d[], is
