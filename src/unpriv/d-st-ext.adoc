...
comprise floating-point loads and stores (insn:fl*[]/insn:fs*[]) and
floating-point move instructions (insn:fmv.*.x[]/insn:fmv.x.*[]).
...
32-bit result#. [#norm:fcvt_long_double_rv64_only]#insn:fcvt.l.d[], insn:fcvt.lu.d[], insn:fcvt.d.l[] and insn:fcvt.d.lu[] are RV64-only instructions.#
[#norm:fcvt_int_double_valid_input]#The range of valid inputs for insn:fcvt._int_.d[] and the behavior for invalid
inputs are the same as for insn:fcvt._int_.s[], where insn:_int_[] is insn:w[] or insn:wu[]#.
(((floating point, convert and move)))

All floating-point to integer and integer to floating-point conversion
instructions round according to the _rm_ field. Note insn:fcvt.d.w[] and insn:fcvt.d.wu[] always
produce an exact result and is unaffected by rounding mode.
...
destination#. [#norm:fcvt_float_rounding]#insn:fcvt.s.d[] rounds according to the RM field; insn:fcvt.d.s[] will
never round#.
