...
floating-point, which adds [#norm:d_ieee_compliance]#computational instructions
compliant with the IEEE 754-2008 arithmetic standard's binary64 format and
operations.#  The ext:d[] extension depends on the <<single-float,F>> extension.
