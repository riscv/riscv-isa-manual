...
insnlink:vfncvt.rod.f.f.w[]. The final convert from FP32 to BF16 would use
the desired rounding mode.
====

==== insnlink:vfncvtbf16.f.f.w[]

Synopsis::
Vector convert FP32 to BF16

Mnemonic::
insnlink:vfncvtbf16.f.f.w[vd,vs2,vm]
...
This instruction is similar to insnlink:vfncvt.f.f.w[] which converts a
...
==== insnlink:vfwcvtbf16.f.f.v[]

Synopsis::
Vector convert BF16 to FP32

Mnemonic::
insnlink:vfwcvtbf16.f.f.v[vd,vs2,vm]
...
This instruction is similar to insnlink:vfwcvt.f.f.v[] which converts a
