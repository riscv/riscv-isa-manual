[[ext:zfhmin]]
=== ext:zfhmin[] Extension for Half-Precision Floating-Point Conversions
...
ext:zfh[] extension: insnlink:flh[], insnlink:fsh[], insnlink:fmv.x.h[], insnlink:fmv.h.x[],
insnlink:fcvt.s.h[], and insnlink:fcvt.h.s[]. If the ext:d[] extension is present, the
insnlink:fcvt.d.h[] and insnlink:fcvt.h.d[] instructions are also included. If the
ext:q[] extension is present, the insnlink:fcvt.q.h[] and
insnlink:fcvt.h.q[] instructions are additionally included.

[NOTE]
====
ext:zfhmin[] does not include the insnlink:fsgnj.h[] instruction, because it suffices to
instead use the insnlink:fsgnj.s[] instruction to move half-precision values
