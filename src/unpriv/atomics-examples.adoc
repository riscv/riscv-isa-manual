...
The following example code sequence illustrates the use of insnlink:amocas.d[] in a
...
The following example code sequence illustrates the use of insnlink:amocas.q[] to
...
and its associated modification counter using the insnlink:amocas.q[] instruction to
