...
This extension includes six instructions: the insnlink:fcvt.bf16.s[] and
insnlink:fcvt.s.bf16[] instructions, defined below, and the insnlink:flh[], insnlink:fsh[],
insnlink:fmv.x.h[], and insnlink:fmv.h.x[] instructions, defined in extlink:zfh[].
...
==== insnlink:fcvt.bf16.s[]

Synopsis::
Convert FP32 value to a BF16 value

Mnemonic::
insnlink:fcvt.bf16.s[rd,rs1]
...
==== insnlink:fcvt.s.bf16[]

Synopsis::
Convert BF16 value to an FP32 value

Mnemonic::
insnlink:fcvt.s.bf16[rd,rs1]
