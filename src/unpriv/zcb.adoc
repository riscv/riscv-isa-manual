...
For example, insnlink:c.mul[] is only implemented if extlink:m[] or extlink:zmmul[] is
implemented, and insnlink:c.sext.b[] is only implemented if extlink:zbb[] is
implemented.
...
|yes
|yes
|insnlink:c.lbu[rd', uimm(rs1')]
|<<#insns-c_lbu>>

|yes
|yes
|insnlink:c.lhu[rd',uimm(rs1')]
|<<#insns-c_lhu>>

|yes
|yes
|insnlink:c.lh[rd',uimm(rs1')]
|<<#insns-c_lh>>

|yes
|yes
|insnlink:c.sb[rs2',uimm(rs1')]
|<<#insns-c_sb>>

|yes
|yes
|insnlink:c.sh[rs2',uimm(rs1')]
|<<#insns-c_sh>>

|yes
|yes
|insnlink:c.zext.b[rsd']
|<<#insns-c_zext_b>>

|yes
|yes
|insnlink:c.sext.b[rsd']
|<<#insns-c_sext_b>>

|yes
|yes
|insnlink:c.zext.h[rsd']
|<<#insns-c_zext_h>>

|yes
|yes
|insnlink:c.sext.h[rsd']
|<<#insns-c_sext_h>>

|
|yes
|insnlink:c.zext.w[rsd']
|<<#insns-c_zext_w>>
