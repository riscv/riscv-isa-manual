...
When ext:zicfiss[] is enabled, each function that needs to spill the link register,
...
of the current privilege mode.# [#norm:ssp_field_1_0]#The bits 1:0 of csr:ssp[] are read-only zero. If the
