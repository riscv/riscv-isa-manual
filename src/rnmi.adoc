...
include::{incimage}bytefield/mnscratch.edn[]
...
include::{incimage}bytefield/mnepc.edn[]
...
include::{incimage}bytefield/mncause.edn[]
...
include::{incimage}bytefield/mnstatus.edn[]
