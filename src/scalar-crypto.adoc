...
|Zbb (xref:b-st-ext.adoc#zbb[Zbb: Basic bit-manipulation])
|1.0.0
|Frozen
...
(xref:b-st-ext.adoc#insns-brev8[],reftext="Reverse bits in bytes")
=== brev8
...
for their behavior cite:[HaLe98,HaLe98],cite:[BaLuMi:11], and (3) ample
