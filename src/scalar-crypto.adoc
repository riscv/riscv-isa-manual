...
RISC-V Bitmanip extensions (see xref:b-st-ext.adoc#bits[ "B" Extension for Bit Manipulation]).
...
See xref:b-st-ext.adoc#zbkb,Bit-manipulation for Cryptography[Bit-manipulation for Cryptography] for details of these instructions.
...
See xref:b-st-ext.adoc#zbkc,Carry-less multiplication for Cryptography[Carry-less multiplication for Cryptography] for details of these instructions.
...
See xref:b-st-ext.adoc#zbkx,Crossbar permutations[Crossbar permutations] for a complete description of these instructions.
