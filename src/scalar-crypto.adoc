...
====
include::images/es_state.svg[title="Entropy Source state transition diagram.", align="center",scaledwidth=40%]
...
====
include::images/es_dataflow.svg[align="center",scaledwidth=50%]
...
====
include::images/es_noisetest.svg[title="Entropy source can't be read in test mode.", align="center",scaledwidth=66%]
