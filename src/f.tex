...
non-canonical NaNs are preserved.  When FLEN$>$32, bits 32 and above of
the destination register are filled with all ones, as explained in
Section~\ref{nanboxing}.
