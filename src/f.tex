...
FMADD.S multiplies the values in {\em rs1} and {\em rs2}, adds the
value in {\em rs3}, and writes the final result to {\em rd}. FMADD.S
computes {\em (rs1$\times$rs2)+rs3}.  FMSUB.S multiplies the values in
{\em rs1} and {\em rs2}, subtracts the value in {\em rs3}, and writes
the final result to {\em rd}.  FMSUB.S computes {\em (rs1$\times$rs2)-rs3}.

FNMADD.S multiplies the values in {\em rs1} and {\em rs2}, adds the
value in {\em rs3}, and writes the negation of the final result to
{\em rd}. FNMADD.S computes {\em -((rs1$\times$rs2)+rs3}. FNMSUB.S
multiplies the values in {\em rs1} and {\em rs2}, subtracts the value
in {\em rs3}, and writes the negation of the final result to
{\em rd}. FNMSUB.S computes {\em -((rs1$\times$rs2)-rs3}.

In other words, FNMADD.S is the negation of FMADD.S, and FNMSUB.S is
the negation of FMSUB.S.
