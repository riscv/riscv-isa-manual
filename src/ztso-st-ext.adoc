...
xref:rvwmo.adoc#overlapping-ordering[4-7] redundant. They also make
...
xref:rvwmo.adoc#overlapping-ordering[5-7]. In both of these
memory models, it is the xref:rvwmo.adoc#ax-load[Load Value Axiom] that allows a hart to forward a value from its
