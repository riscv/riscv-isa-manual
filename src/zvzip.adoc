...
(`vd`) by alternating elements from the two sources.                           +
                                                                               +
For destination element index `i`:                                             +
If `i` is even: `vd[i] = vs2[i/2]`
If `i` is odd:  `vd[i] = vs1[i/2]`                                             +
                                                                               +
...
register group.                                                                +
                                                                               +
For destination element index `i`:                                             +
If `i` is even: `vd[i] = vs2[i]`
If `i` is odd:  `vd[i] = vs1[i - 1]`                                           +
                                                                               +
Equivalently, the result order is:
...
register group.                                                                +
                                                                               +
For destination element index `i`:                                             +
If `i` is even: `vd[i] = vs2[i + 1]`
If `i` is odd:  `vd[i] = vs1[i]`                                               +
                                                                               +
Equivalently, the result order is:
