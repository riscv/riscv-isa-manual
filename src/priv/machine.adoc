...
The csr::[sd] bit is read-only and is set when either the csr::[fs], csr::[vs], or csr::[xs] bits
...
shown in <<norm:mcause_enc_img>>. The `mcause` register must be implemented.
