[appendix]
== Privileged RV64 Instructions
:doctype: book
// Now the document header is complete and the wavedrom attribute is active.


[#udb:doc:inst:rv64:dret]
=== pass:[<a id="insn:dret"></a>]dret
...
[#udb:doc:inst:rv64:hfence_gvma]
=== pass:[<a id="insn:hfence.gvma"></a>]hfence.gvma
...
[#udb:doc:inst:rv64:hfence_vvma]
=== pass:[<a id="insn:hfence.vvma"></a>]hfence.vvma
...
[#udb:doc:inst:rv64:hinval_gvma]
=== pass:[<a id="insn:hinval.gvma"></a>]hinval.gvma
...
[#udb:doc:inst:rv64:hinval_vvma]
=== pass:[<a id="insn:hinval.vvma"></a>]hinval.vvma
...
[#udb:doc:inst:rv64:hlv_b]
=== pass:[<a id="insn:hlv.b"></a>]hlv.b
...
[#udb:doc:inst:rv64:hlv_bu]
=== pass:[<a id="insn:hlv.bu"></a>]hlv.bu
...
[#udb:doc:inst:rv64:hlv_d]
=== pass:[<a id="insn:hlv.d"></a>]hlv.d

Synopsis::
Hypervisor load doubleword
...
Description::
Load 64 bits of data into register `xd` from guest physical memory at the
...
[#udb:doc:inst:rv64:hlv_h]
=== pass:[<a id="insn:hlv.h"></a>]hlv.h
...
[#udb:doc:inst:rv64:hlv_hu]
=== pass:[<a id="insn:hlv.hu"></a>]hlv.hu
...
[#udb:doc:inst:rv64:hlv_w]
=== pass:[<a id="insn:hlv.w"></a>]hlv.w
...
[#udb:doc:inst:rv64:hlv_wu]
=== pass:[<a id="insn:hlv.wu"></a>]hlv.wu
...
[#udb:doc:inst:rv64:hlvx_hu]
=== pass:[<a id="insn:hlvx.hu"></a>]hlvx.hu
...
[#udb:doc:inst:rv64:hlvx_wu]
=== pass:[<a id="insn:hlvx.wu"></a>]hlvx.wu
...
[#udb:doc:inst:rv64:hsv_b]
=== pass:[<a id="insn:hsv.b"></a>]hsv.b
...
[#udb:doc:inst:rv64:hsv_d]
=== pass:[<a id="insn:hsv.d"></a>]hsv.d

Synopsis::
Hypervisor store doubleword
...
Description::
Store 64 bits of data from register `xs2` to guest physical memory at the
address in `xs1`, as though V=1.
...
[#udb:doc:inst:rv64:hsv_h]
=== pass:[<a id="insn:hsv.h"></a>]hsv.h
...
[#udb:doc:inst:rv64:hsv_w]
=== pass:[<a id="insn:hsv.w"></a>]hsv.w
...
[#udb:doc:inst:rv64:mnret]
=== pass:[<a id="insn:mnret"></a>]mnret
...
[#udb:doc:inst:rv64:mret]
=== pass:[<a id="insn:mret"></a>]mret
...
[#udb:doc:inst:rv64:sctrclr]
=== pass:[<a id="insn:sctrclr"></a>]sctrclr
...
* ext:Smctr[] is not implemented
* The instruction is executed in S/VS/VU-mode and ext:Ssctr[] is not implemented, or xref:csrs:mstateen0.adoc#udb:doc:csr_field:mstateen0:CTR[mstateen0.CTR]=0
...
[#udb:doc:inst:rv64:sfence_inval_ir]
=== pass:[<a id="insn:sfence.inval.ir"></a>]sfence.inval.ir
...
[#udb:doc:inst:rv64:sfence_vma]
=== pass:[<a id="insn:sfence.vma"></a>]sfence.vma
...
[#udb:doc:inst:rv64:sfence_w_inval]
=== pass:[<a id="insn:sfence.w.inval"></a>]sfence.w.inval
...
[#udb:doc:inst:rv64:sinval_vma]
=== pass:[<a id="insn:sinval.vma"></a>]sinval.vma
...
[#udb:doc:inst:rv64:sret]
=== pass:[<a id="insn:sret"></a>]sret
...
[#udb:doc:inst:rv64:wfi]
=== pass:[<a id="insn:wfi"></a>]wfi
