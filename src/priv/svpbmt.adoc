[[ext:svpbmt]]
=== ext:svpbmt[] Extension for Page-Based Memory Types

[#norm:Svpbmt_pte_bits]#In Sv39, Sv48, and Sv57, bits 62-61 of a leaf page table entry indicate
...
MODE=Bare. [#norm:Svpbmt_aliasing_attribute]#In such cases,
