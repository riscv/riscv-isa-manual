...
in <<ext:zicsr>>. In this chapter, we map out the CSR address space. The
...
[#norm:Zicsr_debug_illegal]#`0x7B0`-`0x7BF` are only visible to debug mode.
...
{nbsp} +
Performance-monitoring counter. +
Upper qty:32[bits] of csr:cycle[], RV32 only. +
Upper qty:32[bits] of csr:time[], RV32 only. +
Upper qty:32[bits] of csr:instret[], RV32 only. +
Upper qty:32[bits] of csr:hpmcounter3[], RV32 only. +
Upper qty:32[bits] of csr:hpmcounter4[], RV32 only. +
{nbsp} +
Upper qty:32[bits] of csr:hpmcounter31[], RV32 only.
|===
...
Upper qty:32[bits] of csr:stimecmp[], RV32 only.
...
Upper qty:32[bits] of csr:hedeleg[], RV32 only.
...
Upper qty:32[bits] of csr:henvcfg[], RV32 only.
...
Upper qty:32[bits] of csr:htimedelta[], RV32 only.
...
|Hypervisor State Enable 0 Register. +
 ...
 Upper qty:32[bits] of Hypervisor State Enable 0 Register, RV32 only. +
 Upper qty:32[bits] of Hypervisor State Enable 1 Register, RV32 only. +
 Upper qty:32[bits] of Hypervisor State Enable 2 Register, RV32 only. +
 Upper qty:32[bits] of Hypervisor State Enable 3 Register, RV32 only.
...
Upper qty:32[bits] of csr:vstimecmp[], RV32 only.
...
Upper qty:32[bits] of csr:medeleg[], RV32 only.
...
Upper qty:32[bits] of csr:menvcfg[], RV32 only. +
Machine security configuration register. +
Upper qty:32[bits] of csr:mseccfg[], RV32 only.
...
|Machine State Enable 0 Register. +
 ...
 Upper qty:32[bits] of Machine State Enable 0 Register, RV32 only. +
 Upper qty:32[bits] of Machine State Enable 1 Register, RV32 only. +
 Upper qty:32[bits] of Machine State Enable 2 Register, RV32 only. +
 Upper qty:32[bits] of Machine State Enable 3 Register, RV32 only.
...
{nbsp} +
Machine performance-monitoring counter. +
Upper qty:32[bits] of csr:mcycle[], RV32 only. +
Upper qty:32[bits] of csr:minstret[], RV32 only. +
Upper qty:32[bits] of csr:mhpmcounter3[], RV32 only. +
Upper qty:32[bits] of csr:mhpmcounter4[], RV32 only. +
{nbsp} +
Upper qty:32[bits] of csr:mhpmcounter31[], RV32 only.
...
{nbsp} +
Machine performance-monitoring event selector. +
Upper qty:32[bits] of csr:mcyclecfg[], RV32 only. +
Upper qty:32[bits] of csr:minstretcfg[], RV32 only. +
Upper qty:32[bits] of csr:mhpmevent3[], RV32 only. +
Upper qty:32[bits] of csr:mhpmevent4[], RV32 only. +
{nbsp} +
Upper qty:32[bits] of csr:mhpmevent31[], RV32 only.
