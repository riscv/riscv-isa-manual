...
Instructions that access a non-existent CSR address are reserved.
...
|`0x183` |SRW |csr:spmpen[] |Supervisor physical memory protection entry enable
|`0x193` |SRW |csr:spmpenh[] |Upper qty:32[bits] of csr:spmpen[], RV32 only
...
|`0x316` |MRW |csr:mpmpdeleg[] |Physical memory protection delegation register
