...
|*Shcounterenw Extension* |*1.0*
|*Shvstvala Extension* |*1.0*
|*Shvstvecd Extension* |*1.0*
|*Shvsatpa Extension* |*1.0*
|*Shgatpa Extension* |*1.0*
|*Sha Extension* |*1.0*
|===
...
* Defined `mseccfg` and `mseccfgh` CSRs, which control the
