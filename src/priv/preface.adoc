...
* Clarified that insnlink:wfi[] is not a HINT instruction.
...
* Changed insnlink:mret[] and insnlink:sret[] to clear csr:mstatus[mprv] when leaving M-mode.
...
* PMP changes require an insnlink:sfence.vma[] on any hart that implements
...
`pc` to `__x__tval`.
* Clarified that bare S-mode need not support the insnlink:sfence.vma[]
instruction.
...
* insnlink:sfence.vma[] semantics have been clarified.
...
insnlink:sfence.vma[] instruction.
