[[chap:zihintntl]]
== "Zihintntl" Non-Temporal Locality Hints, Version 0.3

[NOTE]
====
This *frozen* specification has not yet been ratified.  Change is unlikely; an incompatible change will only be made if a critical issue is identified during the public-review period.
====
