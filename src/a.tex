...
Complex atomic memory operations on a single memory word or a single doubleword are performed
...
For RV64, LR.W and SC.W always sign-extend the value placed in {\em rd}.
