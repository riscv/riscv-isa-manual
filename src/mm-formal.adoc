...
provided in xref:rvwmo.adoc#memorymodel[RVWMO Memory Consistency Model] and in the rest of
the main body of the ISA specification.
All currently known discrepancies are listed in xref:mm-eplan.adoc#discrepencies[Known Issues].
...
how Alloy can be used to model check some of the mappings in xref:mm-eplan.adoc#momory_porting[Code Porting and Mapping Guidelines].
...
xref:rvwmo.adoc#memorymodel[RVWMO Memory Consistency Model], definition of RVWMO, as much
