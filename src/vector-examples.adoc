...
----
include::{incexample}/vvaddint32.s[lines=4..-1]
----
...
----
include::{incexample}/memcpy.s[lines=4..-1]
----
...
----
include::{incexample}/saxpy.s[lines=4..-1]
----

== SGEMM example

----
include::{incexample}/sgemm.S[lines=4..-1]
----
...
----
include::{incexample}/strcmp.s[lines=4..-1]
----
