...
----
include::unpriv:example$/vvaddint32.s[lines=4..-1]
----
...
----
include::unpriv:example$/memcpy.s[lines=4..-1]
----
...
----
include::unpriv:example$/saxpy.s[lines=4..-1]
----

== SGEMM example

----
include::unpriv:example$/sgemm.S[lines=4..-1]
----
...
----
include::unpriv:example$/strcmp.s[lines=4..-1]
----

include::unpriv:partial$fraclmul.adoc[]
