...
(draw-box "L" {:span 5 :borders {}})
(draw-box "0" {:span 6 :borders {}})
(draw-box "A" {:span 6 :borders {}})
(draw-box "X" {:span 5 :borders {}})
(draw-box "W" {:span 5 :borders {}})
(draw-box "R" {:span 5 :borders {}})
