...
], config:{fontsize: 10, label:{right: 'I-immediate'}}}
....
//#### S-immediate
...
{reg: [
  ...
  {bits: 6,  name: 'inst[30:25]'},
  {bits: 21,  name: '— inst[31] —', type: 7},
], config:{fontsize: 10, label:{right: 'S-immediate'}}}
....
//#### B-immediate
...
], config:{fontsize: 10, label:{right: 'B-immediate'}}}
....
//#### U-immediate
...
], config:{fontsize: 10, label:{right: 'U-immediate'}}}
....
//#### J-immediate
...
], config:{fontsize: 10, label:{right: 'J-immediate'}}}
....
