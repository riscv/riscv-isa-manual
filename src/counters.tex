...
\section{``Zicntr'' Base Counters and Timers, Version 2.0}
...
The Zicntr extension provides a number of 64-bit read-only user-level counters, which
...
\section{``Zihpm'' Hardware Performance Counters, Version 2.0}

The Zihpm extension allocates CSR space for 29 additional unprivileged 64-bit
