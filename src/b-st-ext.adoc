...
It is the inverse of the xref:scalar-crypto.adoc#insns-zip-sc[zip] instruction.
...
It is the inverse of the xref:scalar-crypto.adoc#insns-unzip-sc[unzip] instruction.
This instruction is available only on RV32.
