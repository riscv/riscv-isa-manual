...
[#norm:Zicntr:rdcycle]#The RDCYCLE pseudoinstruction reads the low XLEN bits of the `cycle`
...
====
[#norm:Zicntr:rdtime]#The RDTIME pseudoinstruction reads the low XLEN bits of the "time" CSR,
...
example).
====
[#norm:Zicntr:rdinstret]#The RDINSTRET pseudoinstruction reads the low XLEN bits of the
...
[#norm:Zihpm:counters]#The Zihpm extension comprises up to 29 additional unprivileged 64-bit
