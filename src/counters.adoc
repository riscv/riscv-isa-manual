...
[#norm:zicntr_rdcycle]#The RDCYCLE pseudoinstruction reads the low XLEN bits of the `cycle`
...
====
[#norm:zicntr_rdtime]#The RDTIME pseudoinstruction reads the low XLEN bits of the "time" CSR,
...
example).
====
[#norm:zicntr_rdinstret]#The RDINSTRET pseudoinstruction reads the low XLEN bits of the
...
[#norm:zihpm_counters]#The Zihpm extension comprises up to 29 additional unprivileged 64-bit
