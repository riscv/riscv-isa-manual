...
RV32I/RV64I, and so should be read after xref:rv32.adoc[RV32I Base Integer Instruction Set, Version 2.1] and xref:rv64.adoc[RV64I Base Integer Instruction Set, Version 2.1].
(((RV32E, design)))
[NOTE]
====
