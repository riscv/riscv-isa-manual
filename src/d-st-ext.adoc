...
include::{incimage}wavedrom/double-ls.edn[]
[[double-ls]]
...
include::{incimage}wavedrom/double-fl-compute.edn[]
[[fl-compute]]
...
include::{incimage}wavedrom/double-fl-convert-mv.edn[]
[[fl-convert-mv]]
...
include::{incimage}wavedrom/fcvt-sd-ds.edn[]
[[fcvt-sd-ds]]
...
include::{incimage}wavedrom/fsjgnjnx-d.edn[]
...
include::{incimage}wavedrom/d-xwwx.edn[]
[[fmvxddx]]
...
include::{incimage}wavedrom/double-fl-compare.edn[]
[[fl-compare]]
...
include::{incimage}wavedrom/double-fl-class.edn[]
[[fl-class]]
