...
64 bits (FLEN=64 in xref:f-st-ext.adoc#fprs[RISC-V standard F extension single-precision floating-point state]. The `f` registers can
now hold either 32-bit or 64-bit floating-point values as described
below in <<sec:nanboxing, NaN Boxing of Narrower Values>>.
...
include::unpriv:partial$wavedrom/double-ls.adoc[]
[[double-ls]]
...
include::unpriv:partial$wavedrom/double-fl-compute.adoc[]
[[fl-compute]]
...
include::unpriv:partial$wavedrom/double-fl-convert-mv.adoc[]
[[fl-convert-mv]]
...
include::unpriv:partial$wavedrom/fcvt-sd-ds.adoc[]
[[fcvt-sd-ds]]
...
include::unpriv:partial$wavedrom/fsjgnjnx-d.adoc[]
...
include::unpriv:partial$wavedrom/d-xwwx.adoc[]
[[fmvxddx]]
...
include::unpriv:partial$wavedrom/double-fl-compare.adoc[]
[[fl-compare]]
...
include::unpriv:partial$wavedrom/double-fl-class.adoc[]
[[fl-class]]
