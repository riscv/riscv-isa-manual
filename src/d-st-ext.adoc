...
image::wavedrom/double-fl-compute.edn[]
[[fl-compute]]
...
image::wavedrom/double-fl-convert-mv.edn[]
[[fl-convert-mv]]
...
image::wavedrom/double-fl-compare.edn[]
[[fl-compare]]
...
image::wavedrom/double-fl-class.edn[]
[[fl-class]]
