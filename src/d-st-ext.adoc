...
include::{incimages}wavedrom/double-ls.edn[]
[[double-ls]]
...
include::{incimages}wavedrom/double-fl-compute.edn[]
[[fl-compute]]
...
include::{incimages}wavedrom/double-fl-convert-mv.edn[]
[[fl-convert-mv]]
...
include::{incimages}wavedrom/fcvt-sd-ds.edn[]
[[fcvt-sd-ds]]
...
include::{incimages}wavedrom/fsjgnjnx-d.edn[]
...
include::{incimages}wavedrom/d-xwwx.edn[]
[[fmvxddx]]
...
include::{incimages}wavedrom/double-fl-compare.edn[]
[[fl-compare]]
...
include::{incimages}wavedrom/double-fl-class.edn[]
[[fl-class]]
