...
64 bits (FLEN=64 in xref:f-st-ext.adoc#fprs[F extension single-precision floating-point state]. The `f` registers can
...
include::partial$wavedrom/double-ls.edn[]
[[double-ls]]
...
include::partial$wavedrom/double-fl-compute.edn[]
[[fl-compute]]
...
include::partial$wavedrom/double-fl-convert-mv.edn[]
[[fl-convert-mv]]
...
include::partial$wavedrom/fcvt-sd-ds.edn[]
[[fcvt-sd-ds]]
...
include::partial$wavedrom/fsjgnjnx-d.edn[]
...
include::partial$wavedrom/d-xwwx.edn[]
[[fmvxddx]]
...
include::partial$wavedrom/double-fl-compare.edn[]
[[fl-compare]]
...
include::partial$wavedrom/double-fl-class.edn[]
[[fl-class]]
