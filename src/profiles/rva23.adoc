...
- <<sec:pm-exts,**Supm**>> Pointer masking, with the execution environment providing a means to
...
- <<ziccamoc,**Ziccamoc**>> Main memory regions with both the cacheability and coherence PMAs
...
- <<zama16b,**Zama16b**>> Misaligned loads, stores, and AMOs to main memory regions that do not cross a naturally aligned 16-byte boundary are atomic.
