...
function of {\tt misa}, and any write to {\tt misa} may cause SXL to
...
{\tt misa}, and any write to {\tt misa} may cause UXL to change as a
side effect. If S-mode is supported, the allowed values
