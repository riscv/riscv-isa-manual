...
The ``T'' bit is read-only, and all harts within the execution environment
must hardwire the ``T'' bit to the same value, indicating either that they
all implement RVWMO (0) or all implement RVTSO (1).
