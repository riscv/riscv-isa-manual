...
\subsection{``Smdisc'' Extension for Machine Configuration Pointer ({\tt mconfigptr}) CSR}

This section defines the Smdisc extension, which adds the {\tt mconfigptr} CSR.
...
{\tt mconfigptr}[$\log_2n$-1:0] must be hardwired to 0.
