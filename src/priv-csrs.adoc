...
|`0x183` |SRW |`spmpen` |Supervisor physical memory protection entry enable.
|`0x193` |SRW |`spmpenh` |Upper 32 bits of supervisor physical memory protection entry enable, RV32 only.
...
|`0x316` |MRW |`mpmpdeleg` |Physical memory protection delegation register.
