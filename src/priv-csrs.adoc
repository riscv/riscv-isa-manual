...
|`0x183` |SRW |`spmpmask` |Supervisor physical memory protection mask.
|`0x193` |SRW |`spmpmaskh` |Upper 32 bits of supervisor physical memory protection mask, RV32 only.
