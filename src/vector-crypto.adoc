...
We treat these operands as a vector of one or more _element groups_ as defined in xref:v-st-ext.adoc#vector-element-groups[Vector Element Groups].
...
xref:scalar-crypto.adoc#crypto_scalar_instructions[RISC-V Scalar Cryptography Extensions specification].
