...
[NOTE]
====
_The RISC-V ISA is designed to support a wide variety of implementations
with various experimental instruction-set extensions. We have found that
an organized naming scheme simplifies software tools and documentation._
====
=== Case Sensitivity
...
<<zifencei, Chapter 3>>; "Zifencei2" and
...
<<isanametable, Table 42>> summarizes the standardized extension
