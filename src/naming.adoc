...
last letter is "p". For example, "Zifencei" names the instruction-fetch fence extension described in
xref:zifencei.adoc["Zifencei" Extension for Instruction-Fetch Fence]; "Zifencei2" and
