...
described in xref:d-st-ext.adoc#nanboxing[NaN Boxing of Narrower Values] is extended to allow a
...
include::unpriv:partial$wavedrom/sp-load-store.adoc[]
[[sp-load-store]]
//.Half-precision load and store instructions
...
include::unpriv:partial$wavedrom/spfloat-zfh.adoc[]

include::unpriv:partial$wavedrom/spfloat2-zfh.adoc[]
...
include::unpriv:partial$wavedrom/half-prec-conv-and-mv.adoc[]
...
include::unpriv:partial$wavedrom/half-prec-flpt-to-flpt-conv.adoc[]
...
include::unpriv:partial$wavedrom/flt-to-flt-sgn-inj-instr.adoc[]
...
include::unpriv:partial$wavedrom/flt-pt-to-int-move.adoc[]
[[flt-pt-to-int-move]]
...
include::unpriv:partial$wavedrom/half-pr-flt-pt-compare.adoc[]
...
include::unpriv:partial$wavedrom/half-pr-flt-pt-class.adoc[]
[[half-pr-flt-class]]
