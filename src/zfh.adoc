...
described in xref:f-st-ext.adoc#nanboxing{NaN Boxing of Narrower Values] is extended to allow a
...
include::unpriv:partial$wavedrom/sp-load-store.edn[]
[[sp-load-store]]
//.Half-precision load and store instructions
...
include::unpriv:partial$wavedrom/spfloat-zfh.edn[]

include::unpriv:partial$wavedrom/spfloat2-zfh.edn[]
...
include::unpriv:partial$wavedrom/half-prec-conv-and-mv.edn[]
...
include::unpriv:partial$wavedrom/half-prec-flpt-to-flpt-conv.edn[]
...
include::unpriv:partial$wavedrom/flt-to-flt-sgn-inj-instr.edn[]
...
include::unpriv:partial$wavedrom/flt-pt-to-int-move.edn[]
[[flt-pt-to-int-move]]
...
include::unpriv:partial$wavedrom/half-pr-flt-pt-compare.edn[]
...
include::unpriv:partial$wavedrom/half-pr-flt-pt-class.edn[]
[[half-pr-flt-class]]
