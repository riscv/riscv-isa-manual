...
include::{incimage}wavedrom/sp-load-store.edn[]
[[sp-load-store]]
//.Half-precision load and store instructions
...
include::{incimage}wavedrom/spfloat-zfh.edn[]

include::{incimage}wavedrom/spfloat2-zfh.edn[]
...
include::{incimage}wavedrom/half-prec-conv-and-mv.edn[]
...
include::{incimage}wavedrom/half-prec-flpt-to-flpt-conv.edn[]
...
include::{incimage}wavedrom/flt-to-flt-sgn-inj-instr.edn[]
...
include::{incimage}wavedrom/flt-pt-to-int-move.edn[]
[[flt-pt-to-int-move]]
...
include::{incimage}wavedrom/half-pr-flt-pt-compare.edn[]
...
include::{incimage}wavedrom/half-pr-flt-pt-class.edn[]
[[half-pr-flt-class]]
