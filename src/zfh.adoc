...
include::partial$wavedrom/sp-load-store.adoc[]
[[sp-load-store]]
//.Half-precision load and store instructions
...
include::partial$wavedrom/spfloat-zfh.adoc[]

include::partial$wavedrom/spfloat2-zfh.adoc[]
...
include::partial$wavedrom/half-prec-conv-and-mv.adoc[]
...
include::partial$wavedrom/half-prec-flpt-to-flpt-conv.adoc[]
...
include::partial$wavedrom/flt-to-flt-sgn-inj-instr.adoc[]
...
include::partial$wavedrom/flt-pt-to-int-move.adoc[]
[[flt-pt-to-int-move]]
...
include::partial$wavedrom/half-pr-flt-pt-compare.adoc[]
...
include::partial$wavedrom/half-pr-flt-pt-class.adoc[]
[[half-pr-flt-class]]
