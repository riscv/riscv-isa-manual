...
include::partial$wavedrom/sp-load-store.edn[]
[[sp-load-store]]
//.Half-precision load and store instructions
...
include::partial$wavedrom/spfloat-zfh.edn[]

include::partial$wavedrom/spfloat2-zfh.edn[]
...
include::partial$wavedrom/half-prec-conv-and-mv.edn[]
...
include::partial$wavedrom/half-prec-flpt-to-flpt-conv.edn[]
...
include::partial$wavedrom/flt-to-flt-sgn-inj-instr.edn[]
...
include::partial$wavedrom/flt-pt-to-int-move.edn[]
[[flt-pt-to-int-move]]
...
include::partial$wavedrom/half-pr-flt-pt-compare.edn[]
...
include::partial$wavedrom/half-pr-flt-pt-class.edn[]
[[half-pr-flt-class]]
