...
include::{incimages}wavedrom/sp-load-store.edn[]
[[sp-load-store]]
//.Half-precision load and store instructions
...
include::{incimages}wavedrom/spfloat-zfh.edn[]

include::{incimages}wavedrom/spfloat2-zfh.edn[]
...
include::{incimages}wavedrom/half-prec-conv-and-mv.edn[]
...
include::{incimages}wavedrom/half-prec-flpt-to-flpt-conv.edn[]
...
include::{incimages}wavedrom/flt-to-flt-sgn-inj-instr.edn[]
...
include::{incimages}wavedrom/flt-pt-to-int-move.edn[]
[[flt-pt-to-int-move]]
...
include::{incimages}wavedrom/half-pr-flt-pt-compare.edn[]
...
include::{incimages}wavedrom/half-pr-flt-pt-class.edn[]
[[half-pr-flt-class]]
