...
M-mode. [#norm:Smdbltrp_with_Smrnmi_op]#When the Smrnmi extension (xref:rnmi.adoc#rnmi["Smrnmi" Extension for Resumable Non-Maskable Interrupts]) is implemented, it enables
