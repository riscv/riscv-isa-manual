...
The FENCE instruction only orders observations that an external device
makes via reads and writes to the memory system, not observations
using any other form of signaling mechanism.
