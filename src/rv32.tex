...
For resource-constrained embedded applications, an
RV32E subset, which only has 16 registers, has been proposed.
\end{commentary}
...
\begin{commentary}
  The FENCE.TSO encoding was added as an extension to the
