...
Please see "Shadow Stack Memory Protection" section in Volume II
(RISC-V privileged architecture) of this manual for the exceptions raised by
`SSAMOSWAP.W` if not already marked as illegal/virtual-exception.
