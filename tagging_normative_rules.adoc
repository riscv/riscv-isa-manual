...
Note that the names of any tags referenced by the normative rule aren't obigated to follow this naming convention (e.g., typically tag names are in lower-case)
